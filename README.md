...
- If you don't know java, [take a few minutes to learn the basics](http://code.tutsplus.com/series/learn-java-for-android-development--mobile-22888) and if you don't know Android [learn about it here](http://d.android.com/resources/index.html).  
...
3. In the *source* directory, please create an Android app that accomplishes the following:
	...
	- Find the [square/retrofit](https://github.com/square/retrofit) repository
